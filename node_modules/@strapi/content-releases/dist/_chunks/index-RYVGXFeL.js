...
const admin = {
  ...
  register(app) {
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        async Component() {
          const { App } = await Promise.resolve().then(() => require("./App-ftICpqDz.js"));
          return App;
        },
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-4CUzVH2g.js")) }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-RYVGXFeL.js.map
