...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-pisKLsr8.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.16.0",
  "@strapi/permissions": "4.21.0",
  "@strapi/provider-audit-logs-local": "4.21.0",
  "@strapi/types": "4.21.0",
...
const devDependencies = {
  ...
  "@strapi/data-transfer": "4.21.0",
  "@strapi/pack-up": "4.21.0",
  "@strapi/plugin-content-manager": "4.21.0",
...
const CM = React.lazy(
  () => import("./index-pisKLsr8.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-zpdV3R_J.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-QxMzZSAA.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-wtul_pNK.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-pisKLsr8.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-fzPpJZLL.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-s5Dj-61C.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-nvm4fRcu.mjs.map
