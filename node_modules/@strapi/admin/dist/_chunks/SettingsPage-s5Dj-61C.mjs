...
import { y as SETTINGS_LINKS_CE, p as useEnterprise, u as useConfiguration, d as createRoute } from "./index-pisKLsr8.mjs";
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./constants-i_FIHwfG.mjs")).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-wfXHUaaw.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-ObDt4GbK.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-yKqM0bST.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-xannISFa.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-MeydsvUK.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-ed7j4RJV.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-ZTvR20S6.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-qafrcs26.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-BCc3qmYg.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView--GAlOvKq.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-I4t8PYvh.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-pVkFTxKp.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-CBlwwUD_.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-CsBrOadn.mjs");
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-hYZ8eUpF.mjs")).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-3oj946tc.mjs")).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-s5Dj-61C.mjs.map
