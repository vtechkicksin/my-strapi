...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-pisKLsr8.mjs";
...
import { u as useWebhooks } from "./useWebhooks-g4gI6Wxf.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-uqU4ebwR.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-ZTvR20S6.mjs.map
