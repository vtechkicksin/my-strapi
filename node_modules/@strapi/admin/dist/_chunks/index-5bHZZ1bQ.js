...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await Promise.resolve().then(() => require("./Login-x6cjYspM.js"))).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await Promise.resolve().then(() => require("./constants-ctzjEs9Q.js"))).FORMS,
    {
...
const AuthenticatedApp = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./AuthenticatedApp-2mUijYOI.js")).then((n) => n.AuthenticatedApp).then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App$2 = ({ authLogo, menuLogo, showReleaseNotification, showTutorials }) => {
  const adminPermissions = useEnterprise(
    ADMIN_PERMISSIONS_CE,
    async () => (await Promise.resolve().then(() => require("./constants-6LdQgFgh.js"))).ADMIN_PERMISSIONS_EE,
    {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-6LdQgFgh.js"))).ROUTES_EE,
    {
      defaultValue: []
    }
  );
...
const SelectedEntriesModalContent = ({
  ...
  const { formatMessage } = reactIntl.useIntl();
  const { selectedEntries, rows, onSelectRow, isLoading } = helperPlugin.useTableContext();
  ...
  React__namespace.useEffect(() => {
    if (selectedEntries.length === 0 || selectedEntries.length === selectedEntriesWithErrorsCount || isLoading) {
...
const PublishAction = ({ model: slug }) => {
  ...
  const [isPublishModalBtnDisabled, setIsPublishModalBtnDisabled] = React__namespace.useState(true);
        ...
        return /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.ModalFooter,
          {
            ...
            endActions: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => refetchModalData(), variant: "tertiary", children: formatMessage({ id: "app.utils.refresh", defaultMessage: "Refresh" }) }),
              /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Button,
                {
...
const BulkActionModal = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ModalLayout, { borderRadius: "4px", overflow: "hidden", onClose: handleClose, labelledBy: id, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: typeof Footer === "function" ? /* @__PURE__ */ jsxRuntime.jsx(Footer, { onClose: handleClose }) : Footer })
  ] });
};
...
const EditViewPage = ({
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () => (await Promise.resolve().then(() => require("./InformationBoxEE-ZTOhi2sn.js"))).InformationBoxEE
  );
  useOnce(() => {
...
const ListViewPage = ({
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-P-KABNaY.js"))).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await Promise.resolve().then(() => require("./ReviewWorkflowsColumn-K_K8J7hl.js"));
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-P-KABNaY.js"))).REVIEW_WORKFLOW_FILTERS,
    {
...
//# sourceMappingURL=index-5bHZZ1bQ.js.map
