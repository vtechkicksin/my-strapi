...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-JfsOEES0.mjs")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-PCBjswmE.mjs")).FORMS,
    {
...
const AuthenticatedApp = React.lazy(
  () => import("./AuthenticatedApp-nvm4fRcu.mjs").then((n) => n.A).then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App$2 = ({ authLogo, menuLogo, showReleaseNotification, showTutorials }) => {
  const adminPermissions = useEnterprise(
    ADMIN_PERMISSIONS_CE,
    async () => (await import("./constants-i_FIHwfG.mjs")).ADMIN_PERMISSIONS_EE,
    {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-i_FIHwfG.mjs")).ROUTES_EE,
    {
      defaultValue: []
    }
  );
...
const SelectedEntriesModalContent = ({
  ...
  const { formatMessage } = useIntl();
  const { selectedEntries, rows, onSelectRow, isLoading } = useTableContext();
        ...
        return /* @__PURE__ */ jsx(
          ModalFooter,
          {
            ...
            endActions: /* @__PURE__ */ jsxs(Flex, { gap: 2, children: [
              /* @__PURE__ */ jsx(Button, { onClick: () => refetchModalData(), variant: "tertiary", children: formatMessage({ id: "app.utils.refresh", defaultMessage: "Refresh" }) }),
              /* @__PURE__ */ jsx(
                Button,
                {
...
const BulkActionModal = ({
  ...
  return /* @__PURE__ */ jsxs(ModalLayout, { borderRadius: "4px", overflow: "hidden", onClose: handleClose, labelledBy: id, children: [
    ...
    /* @__PURE__ */ jsx(Fragment, { children: typeof Footer === "function" ? /* @__PURE__ */ jsx(Footer, { onClose: handleClose }) : Footer })
  ] });
};
...
const EditViewPage = ({
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () => (await import("./InformationBoxEE-FcEBL8Fl.mjs")).InformationBoxEE
  );
  useOnce(() => {
...
const ListViewPage = ({
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () => (await import("./constants-cOPVDhHQ.mjs")).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await import("./ReviewWorkflowsColumn-_MYDc8Ry.mjs");
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () => (await import("./constants-cOPVDhHQ.mjs")).REVIEW_WORKFLOW_FILTERS,
    {
...
//# sourceMappingURL=index-pisKLsr8.mjs.map
