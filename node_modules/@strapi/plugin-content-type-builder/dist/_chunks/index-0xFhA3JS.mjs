...
const ListView$1 = lazy(() => import("./ListView-xJSa-0us.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-xJSa-0us.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-0xFhA3JS.mjs.map
