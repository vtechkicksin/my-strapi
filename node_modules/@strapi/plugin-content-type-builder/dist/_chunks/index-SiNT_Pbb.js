...
const index$1 = require("./index-Pf8Klx6h.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-2t96eHob.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-2t96eHob.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-SiNT_Pbb.js.map
